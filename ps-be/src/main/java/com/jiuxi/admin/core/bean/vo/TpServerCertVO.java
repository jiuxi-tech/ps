...
public class TpServerCertVO {
    ...
    @Size(max = 100, message = "证书名称长度不能超过100个字符", groups = {AddGroup.class, UpdateGroup.class})
    private String certName;

    /**
     * 证书描述
     */
    @Size(max = 500, message = "证书描述长度不能超过500个字符", groups = {AddGroup.class, UpdateGroup.class})
     ...
     * 私钥文件内容（BASE64编码）
     */
    @NotBlank(message = "私钥文件内容不能为空", groups = {AddGroup.class, UpdateGroup.class})
    ...
    public void setExpiredStatusText(String expiredStatusText) {
        this.expiredStatusText = expiredStatusText;
    }
