...
-- Database: ps-bmp
-- Export Time: 2025-12-16 17:33:08

SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

-- ----------------------------
-- Table structure for org_tree_change_history
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=103 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='组织机构树变更历史记录表';

-- ----------------------------
-- Table structure for org_tree_version_sequence
-- ----------------------------
...
-- ----------------------------
-- Table structure for s_hd_hiddendangerinfo
-- ----------------------------
...
-- ----------------------------
-- Table structure for s_si_check_rut
-- ----------------------------
...
CREATE TABLE `tp_account` (
  ...
  `IDCARD` varchar(18) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '身份证号,用于登录凭据',
  ...
  KEY `idx_account_idcard` (`IDCARD`),
  KEY `idx_account_phone` (`PHONE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Table structure for tp_account_exinfo
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_account_third
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_agent_deal
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_api_call_log
-- ----------------------------
DROP TABLE IF EXISTS `tp_api_call_log`;
CREATE TABLE `tp_api_call_log` (
  `log_id` varchar(19) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '日志ID（主键）',
  `app_id` varchar(19) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '应用ID',
  `app_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '应用名称（冗余）',
  `api_id` varchar(19) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'API ID',
  `api_path` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '请求路径',
  `http_method` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'HTTP方法',
  `request_ip` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '请求IP',
  `request_params` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '请求参数（脱敏）',
  `response_status` int(11) DEFAULT NULL COMMENT '业务状态码（1:成功, -1:失败, 401:认证失败, 403:权限不足, 500:服务器错误）',
  `response_time` int(11) DEFAULT NULL COMMENT '响应时间（毫秒）',
  `error_message` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '错误信息',
  `call_time` varchar(14) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '调用时间',
...
-- ----------------------------
-- Table structure for tp_api_definition
-- ----------------------------
DROP TABLE IF EXISTS `tp_api_definition`;
CREATE TABLE `tp_api_definition` (
  `api_id` varchar(19) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'API ID（主键）',
  `api_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'API编码（唯一）',
  `api_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'API名称',
  `api_path` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'API路径（如:/open-api/v1/users/{id}）',
  `http_method` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'HTTP方法（GET/POST/PUT/DELETE等）',
  `category` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'API分类',
  `description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'API描述',
  `is_sensitive` int(11) NOT NULL DEFAULT 0 COMMENT '是否敏感接口（1:是 0:否）',
  `require_secret` int(11) NOT NULL DEFAULT 0 COMMENT '是否需要签名验证（1:是 0:否）',
  `status` int(11) NOT NULL DEFAULT 1 COMMENT '状态（1:启用 0:禁用）',
  `order_index` double DEFAULT 0 COMMENT '排序序号',
  `actived` int(11) NOT NULL DEFAULT 1 COMMENT '是否有效（1:有效 0:无效）',
...
-- ----------------------------
-- Table structure for tp_app_api_permission
-- ----------------------------
DROP TABLE IF EXISTS `tp_app_api_permission`;
CREATE TABLE `tp_app_api_permission` (
  `permission_id` varchar(19) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '权限ID（主键）',
  `app_id` varchar(19) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '应用ID（外键）',
  `api_id` varchar(19) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'API ID（外键）',
  `creator` varchar(19) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '创建人',
  `create_time` varchar(14) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '创建时间',
...
-- ----------------------------
-- Table structure for tp_attachinfo
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_custom_form
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_custom_module
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_data_permission_dept
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_data_permission_scope
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_data_permissions
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_database_backup_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_dept_basicinfo
-- ----------------------------
...
CREATE TABLE `tp_dept_basicinfo` (
  ...
  `FULL_DEPT_NAME` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '部门名称层级全路径（如：AAA部>BBB部>CCC办公室）',
  `FULL_DEPT_CODE` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '部门编码层级全路径（各级部门编号以>连接）',
  UNIQUE KEY `DEPT_ID` (`DEPT_ID`),
  KEY `idx_full_dept_name` (`FULL_DEPT_NAME`),
  KEY `idx_full_dept_code` (`FULL_DEPT_CODE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Table structure for tp_dept_basicinfo_deleted_backup
-- ----------------------------
DROP TABLE IF EXISTS `tp_dept_basicinfo_deleted_backup`;
CREATE TABLE `tp_dept_basicinfo_deleted_backup` (
  `DEPT_ID` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '部门ID，主键，唯一标识部门记录',
  `PDEPT_ID` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '父部门ID，用于构建部门层级树形结构，根部门为NULL',
  `DEPT_LEVELCODE` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '部门层级编码，三位数字递增自动生成，用于统计本级及下级部门',
  `DEPT_NO` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '部门编号，部门的唯一业务编码标识',
...
-- ----------------------------
-- Table structure for tp_dept_exinfo
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_ent_basicinfo
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_ip_access_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_keycloak_account
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_licence
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_mediorg
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_mem_verification_code
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_menu_history
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_message_read
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_monitor_client
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_monitor_config
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_operate_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_parameter_config
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_password_history
-- ----------------------------
DROP TABLE IF EXISTS `tp_password_history`;
CREATE TABLE `tp_password_history` (
  `history_id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '历史记录ID',
  `account_id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '账号ID',
  `person_id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '人员ID',
  `username` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '账号用户名',
  `password_hash` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '密码哈希值',
  `change_type` tinyint(4) NOT NULL COMMENT '修改类型：1-用户主动修改 2-管理员重置 3-密码过期强制修改 4-其他',
  `change_reason` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '修改原因说明',
  `changed_by` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '修改操作人ID',
  `changed_by_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '修改操作人姓名',
  `change_time` datetime NOT NULL DEFAULT current_timestamp() COMMENT '密码修改时间',
  `ip_address` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '修改操作的IP地址',
  `user_agent` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '修改操作的用户代理信息',
  `tenant_id` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '租户ID',
  `remark` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '备注信息',
  `created_time` datetime NOT NULL DEFAULT current_timestamp() COMMENT '记录创建时间',
  PRIMARY KEY (`history_id`),
...
-- ----------------------------
-- Table structure for tp_person_audit
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_person_audit_request
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_person_basicinfo
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_person_dept
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_person_exinfo
-- ----------------------------
...
CREATE TABLE `tp_person_exinfo` (
  ...
  `RANK` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '职务职级（如：四级调研员、二级主任科员等）',
  `ZWZJ` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '职务职级（如：四级调研员、科长等）',
  `ZHICHENG` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '职称（如：教授、副教授、工程师等）'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='人员扩展信息表';

-- ----------------------------
-- Table structure for tp_person_role
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_person_tag
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_richtext
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_scheduled_task
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_send_mail_record
-- ----------------------------
...
-- ----------------------------
-- Table structure for tp_server_cert
-- ----------------------------
DROP TABLE IF EXISTS `tp_server_cert`;
CREATE TABLE `tp_server_cert` (
...
-- ----------------------------
-- Table structure for tp_third_party_app
-- ----------------------------
DROP TABLE IF EXISTS `tp_third_party_app`;
CREATE TABLE `tp_third_party_app` (
  `app_id` varchar(19) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '应用ID（主键）',
  `app_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '应用名称',
  `app_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '应用编码（唯一）',
  `api_key` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'API密钥（UUID格式）',
  `api_secret` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'API密钥（BCrypt加密存储）',
  `status` int(11) NOT NULL DEFAULT 1 COMMENT '状态（1:启用 0:禁用）',
  `expire_time` varchar(14) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '过期时间（YYYYMMDDHHmmss），为NULL表示永不过期',
  `description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '应用描述',
  ...
  `ip_whitelist` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'IP白名单（逗号分隔）',
  `rate_limit` int(11) DEFAULT 100 COMMENT '限流配置（次/秒）',
  `last_call_time` varchar(14) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '最后调用时间（yyyyMMddHHmmss）',
  `actived` int(11) NOT NULL DEFAULT 1 COMMENT '是否有效（1:有效 0:无效）',
  `creator` varchar(19) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '创建人',
  `create_time` varchar(14) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '创建时间',
  `updator` varchar(19) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '修改人',
...
-- ----------------------------
-- Table structure for tp_time_rule
-- ----------------------------
...
CREATE TABLE `tp_time_rule` (
  ...
  `CREATOR` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '创建人ID',
  `create_time` varchar(14) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '创建时间（yyyyMMddHHmmss格式）',
  `UPDATOR` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '修改人ID',
  `UPDATE_TIME` varchar(14) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '修改时间（yyyyMMddHHmmss格式）',
  `actived` int(11) DEFAULT 1 COMMENT '是否有效（1：有效，0：无效）',
...
-- ----------------------------
-- View structure for v_org_tree_operation_stats
-- ----------------------------
DROP VIEW IF EXISTS `v_org_tree_operation_stats`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `v_org_tree_operation_stats` AS select 1 AS `operation_type`,1 AS `operation_count`,1 AS `operation_date`,1 AS `operator_name`,1 AS `affected_dept_count`;
