...
--
-- Table structure for table `tp_api_call_log`
--
...
--
-- Table structure for table `tp_api_definition`
--
...
--
-- Table structure for table `tp_app_api_permission`
--
...
--
-- Table structure for table `tp_dept_basicinfo_deleted_backup`
--
...
--
-- Table structure for table `tp_password_history`
--
...
--
-- Table structure for table `tp_server_cert`
--
...
--
-- Table structure for table `tp_third_party_app`
--
...
/*!50001 VIEW `v_org_tree_operation_stats` AS select 1 AS `operation_type`,1 AS `operation_count`,1 AS `operation_date`,1 AS `operator_name`,1 AS `affected_dept_count` */;
...
-- Dump completed on 2025-12-15 20:55:41
