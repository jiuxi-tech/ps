<template>
    <div class="tp-dialog">
        <div class="tp-dialog-top">
            <fb-property bordered>
                <fb-property-item label="证书名称" span="2">
                    {{ formData.certName }}
                </fb-property-item>
...
<!--                </fb-property-item>-->
            ...
            <!-- 操作信息 -->
            <fb-fieldset label="操作信息"></fb-fieldset>
            <fb-property bordered>
...
import FbFieldset from '../../../../fb-ui/packages/components/form/src/FbFieldset.vue'

export default {
    name: 'view',
    components: {FbFieldset},
    mixins: [],
    // 接收父组件的传参
    props: {
        param: {
